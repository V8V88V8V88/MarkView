...
int main() {
    PRINT_CONSTANT((gint) GTK_SOURCE_ANNOTATION_STYLE_ACCENT);
    PRINT_CONSTANT((gint) GTK_SOURCE_ANNOTATION_STYLE_ERROR);
    PRINT_CONSTANT((gint) GTK_SOURCE_ANNOTATION_STYLE_NONE);
    PRINT_CONSTANT((gint) GTK_SOURCE_ANNOTATION_STYLE_WARNING);
    ...
    PRINT_CONSTANT((guint) GTK_SOURCE_SORT_FLAGS_FILENAME);
