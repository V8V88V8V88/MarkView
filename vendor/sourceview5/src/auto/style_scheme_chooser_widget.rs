...
use crate::{ffi, StyleScheme, StyleSchemeChooser};
...
impl StyleSchemeChooserWidget {
    ...
    /// Creates a new builder-pattern struct instance to construct [`StyleSchemeChooserWidget`] objects.
    ///
    /// This method returns an instance of [`StyleSchemeChooserWidgetBuilder`](crate::builders::StyleSchemeChooserWidgetBuilder) which can be used to create [`StyleSchemeChooserWidget`] objects.
    pub fn builder() -> StyleSchemeChooserWidgetBuilder {
        StyleSchemeChooserWidgetBuilder::new()
    }
}
...
// rustdoc-stripper-ignore-next
/// A [builder-pattern] type to construct [`StyleSchemeChooserWidget`] objects.
///
/// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct StyleSchemeChooserWidgetBuilder {
    builder: glib::object::ObjectBuilder<'static, StyleSchemeChooserWidget>,
}

impl StyleSchemeChooserWidgetBuilder {
    fn new() -> Self {
        Self {
    ...
    // rustdoc-stripper-ignore-next
    /// Build the [`StyleSchemeChooserWidget`].
    #[must_use = "Building the object from the builder is usually expensive and is not expected to have side effects"]
    pub fn build(self) -> StyleSchemeChooserWidget {
        assert_initialized_main_thread!();
        self.builder.build()
    }
}
