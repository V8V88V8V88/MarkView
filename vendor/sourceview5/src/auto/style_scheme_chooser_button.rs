...
impl StyleSchemeChooserButton {
    ...
    /// Creates a new builder-pattern struct instance to construct [`StyleSchemeChooserButton`] objects.
    ///
    /// This method returns an instance of [`StyleSchemeChooserButtonBuilder`](crate::builders::StyleSchemeChooserButtonBuilder) which can be used to create [`StyleSchemeChooserButton`] objects.
    pub fn builder() -> StyleSchemeChooserButtonBuilder {
        StyleSchemeChooserButtonBuilder::new()
    }
}
...
// rustdoc-stripper-ignore-next
/// A [builder-pattern] type to construct [`StyleSchemeChooserButton`] objects.
///
/// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct StyleSchemeChooserButtonBuilder {
    builder: glib::object::ObjectBuilder<'static, StyleSchemeChooserButton>,
}
...
impl StyleSchemeChooserButtonBuilder {
    ...
    // rustdoc-stripper-ignore-next
    /// Build the [`StyleSchemeChooserButton`].
