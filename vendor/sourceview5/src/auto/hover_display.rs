...
glib::wrapper! {
    #[doc(alias = "GtkSourceHoverDisplay")]
    ...
    match fn {
        type_ => || ffi::gtk_source_hover_display_get_type(),
    }
}

impl HoverDisplay {
    // rustdoc-stripper-ignore-next
    /// Creates a new builder-pattern struct instance to construct [`HoverDisplay`] objects.
    ///
    /// This method returns an instance of [`HoverDisplayBuilder`](crate::builders::HoverDisplayBuilder) which can be used to create [`HoverDisplay`] objects.
    pub fn builder() -> HoverDisplayBuilder {
...
// rustdoc-stripper-ignore-next
/// A [builder-pattern] type to construct [`HoverDisplay`] objects.
///
/// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct HoverDisplayBuilder {
    builder: glib::object::ObjectBuilder<'static, HoverDisplay>,
}
