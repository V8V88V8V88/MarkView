...
use crate::{ffi, Buffer, Completion, CompletionActivation, CompletionProvider, Language, View};
#[cfg(feature = "v5_6")]
...
impl CompletionContext {
    ...
    >(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                c"provider-model-changed".as_ptr() as *const _,
    ...
    pub fn connect_busy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::busy".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
