...
int main() {
    ...
    PRINT_CONSTANT((guint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_IGNORE_PATHS);
    PRINT_CONSTANT((guint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_IGNORE_SCHEMES);
    PRINT_CONSTANT((guint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_MATCH_BIDIRECTIONALLY);
    PRINT_CONSTANT((guint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_NONE);
