...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    (
        ...
        Layout {
            size: size_of::<WebKitWebExtensionMatchPatternError>(),
            alignment: align_of::<WebKitWebExtensionMatchPatternError>(),
        },
    ),
    (
        "WebKitWebExtensionMatchPatternOptions",
        Layout {
            size: size_of::<WebKitWebExtensionMatchPatternOptions>(),
            alignment: align_of::<WebKitWebExtensionMatchPatternOptions>(),
        },
    ),
    (
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    (
        "(gint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_ERROR_INVALID_HOST",
        "809",
    ),
    (
        "(gint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_ERROR_INVALID_PATH",
        "810",
    ),
    (
        "(gint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_ERROR_INVALID_SCHEME",
        "808",
    ),
    (
        "(gint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_ERROR_UNKNOWN",
        "899",
    ),
    (
        "(guint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_IGNORE_PATHS",
        "4",
    ),
    (
        "(guint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_IGNORE_SCHEMES",
        "2",
    ),
    (
        "(guint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_MATCH_BIDIRECTIONALLY",
        "8",
    ),
    (
        "(guint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_NONE",
        "1",
    ),
